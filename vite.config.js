    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/components/transactions-table.js',
                'resources/js/components/order-cart.js',
                'resources/js/components/csrf-handler.js',
                ...
                'resources/js/pages/topbar-notifications.js',
                'resources/js/pages/notifications.js',
                'resources/js/pages/product-ai-generator.js',
