...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::prefix('inventory')->group(function () {
        ...
        Route::delete('products/{product}/images/{image}', [ProductController::class, 'deleteImage'])->name('admin.inventory.products.images.delete');
    ...
    Route::prefix('chat')->name('admin.chat.')->group(function () {
        ...
        Route::get('/support-staff', [\App\Http\Controllers\Api\ChatController::class, 'getSupportStaff'])->name('support-staff');
