...
class GeminiService
{
    ...
    public function chat(string $userMessage, ?string $context = null): string
    {
        try {
            ...
            $systemPrompt .= "2. إذا كان السؤال عن كتاب متوفر في السياق، اذكر تفاصيله (السعر، الكمية، المؤلف) بدقة كما وردت.\n";
            $systemPrompt .= "3. إذا كان السؤال عن طلب، وضح حالته بناءً على البيانات المتوفرة في سجل الطلبات.\n";
            $systemPrompt .= "4. هام جداً: لا تقم بتأليف أو تخمين أسعار أو كميات من عندك. إذا لم تجد الكتاب في 'سياق المعلومات'، أخبر المندوب بكل صراحة أن الكتاب غير متوفر حالياً في قاعدة البيانات.\n";
            $systemPrompt .= "5. أجب دائماً باللغة العربية بأسلوب مهذب ومساعد.\n";
