...
class GeminiService
{
    ...
    public function chat(string $userMessage, ?string $context = null): string
    {
        try {
            ...
            $systemPrompt .= "2. إذا كان السؤال عن كتاب، وكان هناك عدة نتائج في السياق، قارن بينها بذكاء وقدم الأقرب لطلب المندوب، واذكر البدائل المتاحة إذا كانت مشابهة.\n";
            $systemPrompt .= "3. استخدم بيانات السعر والكمية والرف بدقة كما وردت في السياق.\n";
            $systemPrompt .= "4. هام جداً: إذا كانت الكلمات التي كتبها المندوب بها أخطاء إملائية أو ناقصة، حاول استنتاج الكتاب الصحيح من قائمة النتائج المزودة لك.\n";
            $systemPrompt .= "5. أجب دائماً باللغة العربية بأسلوب مهذب ومساعد جداً.\n";
