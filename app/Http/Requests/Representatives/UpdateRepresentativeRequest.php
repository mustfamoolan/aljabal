...
class UpdateRepresentativeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone' => ['sometimes', 'string', Rule::unique('representatives')->ignore($this->representative), 'regex:/^[0-9+\-\s()]+$/'],
            'email' => ['nullable', 'email', Rule::unique('representatives')->ignore($this->representative)],
