@extends('layouts.vertical', ['title' => 'Representative Add'])
    ...
    <div class="col-lg-12">
        <div class="card">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea id="address" name="address" class="form-control @error('address') is-invalid @enderror"
                                          rows="3" placeholder="أدخل العنوان (اختياري)">{{ old('address') }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            <div class="card-footer border-top">
                <button type="submit" class="btn btn-primary">إنشاء المندوب</button>
