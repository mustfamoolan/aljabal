@extends('layouts.vertical', ['title' => 'Employee Type Add'])
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.employee-types.store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror"
                                       placeholder="أدخل اسم نوع الموظف" value="{{ old('name') }}" required>
                                @error('name')
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" rows="3"
                                          placeholder="أدخل وصف نوع الموظف">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            <div class="card-footer border-top">
                <button type="submit" class="btn btn-primary">إنشاء نوع الموظف</button>
