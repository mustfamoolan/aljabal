                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror"
                                       placeholder="أدخل اسم المنتج" value="{{ old('name') }}" required>
                                @error('name')
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_original" name="is_original" value="1" {{ old('is_original', false) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="is_original">
                                        <span id="product_type_label">{{ old('is_original', false) ? 'أصلي' : 'عادي' }}</span>
                                    </label>
                                </div>
                                @error('is_original')
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="author" name="author" class="form-control @error('author') is-invalid @enderror"
                                       placeholder="أدخل اسم المؤلف" value="{{ old('author') }}">
                                @error('author')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="publisher" name="publisher" class="form-control @error('publisher') is-invalid @enderror"
                                       placeholder="أدخل دار النشر" value="{{ old('publisher') }}">
                                @error('publisher')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="1" id="purchase_price" name="purchase_price" class="form-control @error('purchase_price') is-invalid @enderror"
                                           placeholder="0" value="{{ old('purchase_price') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="1" id="wholesale_price" name="wholesale_price" class="form-control @error('wholesale_price') is-invalid @enderror"
                                           placeholder="0" value="{{ old('wholesale_price') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="1" id="retail_price" name="retail_price" class="form-control @error('retail_price') is-invalid @enderror"
                                           placeholder="0" value="{{ old('retail_price') }}">
                                    @error('retail_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="number" id="quantity" name="quantity" class="form-control @error('quantity') is-invalid @enderror"
                                       placeholder="0" value="{{ old('quantity') }}" min="0">
                                @error('quantity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="number" id="min_quantity" name="min_quantity" class="form-control @error('min_quantity') is-invalid @enderror"
                                       placeholder="0" value="{{ old('min_quantity') }}" min="0">
                                @error('min_quantity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">سيتم التنبيه عند وصول الكمية لهذا الحد</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="unit_type" name="unit_type" class="form-select @error('unit_type') is-invalid @enderror">
                                    ...
                                    @foreach(\App\Enums\UnitType::cases() as $unitType)
                                        <option value="{{ $unitType->value }}" {{ old('unit_type') === $unitType->value ? 'selected' : '' }}>
                                            {{ $unitType->label() }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-lg-6" id="weight_fields" style="display: none;">
                            <div class="row">
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <select id="weight_unit" name="weight_unit" class="form-select">
                                            @foreach(\App\Enums\WeightUnit::cases() as $weightUnit)
                                                <option value="{{ $weightUnit->value }}" {{ old('weight_unit') === $weightUnit->value ? 'selected' : '' }}>
                                                    {{ $weightUnit->label() }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" id="weight_value" name="weight_value" class="form-control"
                                               placeholder="0.00" value="{{ old('weight_value') }}" min="0">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6" id="carton_fields" style="display: none;">
                            <div class="mb-3">
                                ...
                                <input type="number" id="carton_quantity" name="carton_quantity" class="form-control"
                                       placeholder="0" value="{{ old('carton_quantity') }}" min="1">
                            </div>
                        </div>
                        <div class="col-lg-6" id="set_fields" style="display: none;">
                            <div class="mb-3">
                                ...
                                <input type="number" id="set_quantity" name="set_quantity" class="form-control"
                                       placeholder="0" value="{{ old('set_quantity') }}" min="1">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="shelf" name="shelf" class="form-control @error('shelf') is-invalid @enderror"
                                       placeholder="حرف أو رقم" value="{{ old('shelf') }}">
                                @error('shelf')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="compartment" name="compartment" class="form-control @error('compartment') is-invalid @enderror"
                                       placeholder="حرف أو رقم" value="{{ old('compartment') }}">
                                @error('compartment')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="size" name="size" class="form-select @error('size') is-invalid @enderror">
                                    ...
                                    @foreach(\App\Enums\SizeType::cases() as $sizeType)
                                        <option value="{{ $sizeType->value }}" {{ old('size') === $sizeType->value ? 'selected' : '' }}>
                                            {{ $sizeType->label() }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="number" id="page_count" name="page_count" class="form-control @error('page_count') is-invalid @enderror"
                                       placeholder="0" value="{{ old('page_count') }}" min="1">
                                @error('page_count')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_hardcover" name="is_hardcover" value="1" {{ old('is_hardcover', false) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="is_hardcover">
                                        <span id="cover_type_label">{{ old('is_hardcover', false) ? 'هاردكفر' : 'ورقي' }}</span>
                                    </label>
                                </div>
                                @error('is_hardcover')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea id="short_description" name="short_description" class="form-control @error('short_description') is-invalid @enderror" rows="3"
                                          placeholder="وصف مختصر للمنتج">{{ old('short_description') }}</textarea>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea id="long_description" name="long_description" class="form-control @error('long_description') is-invalid @enderror" rows="5"
                                          placeholder="وصف تفصيلي للمنتج">{{ old('long_description') }}</textarea>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <input type="text" id="sku" name="sku" class="form-control @error('sku') is-invalid @enderror"
                               placeholder="سيتم توليده تلقائياً إذا تركت فارغاً" value="{{ old('sku') }}">
                        @error('sku')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
        ...
        <div class="col-12">
            <div class="p-3 bg-light mb-3 rounded">
                <div class="row justify-content-end g-2">
                    ...
                    <div class="col-lg-2">
                        <button type="submit" class="btn btn-primary w-100">إنشاء المنتج</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    window.oldCategoryId = {{ old('category_id', 'null') }};
