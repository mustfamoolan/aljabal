            ...
            <div class="card">
                <div class="card-body border-light">
                    <a href="#"
                        ...
                        aria-controls="categories">الفئات
                        <i class='bx bx-chevron-down ms-auto fs-20'></i>
                    </a>
                    <div id="categories" class="collapse show">
                        <div class="categories-list d-flex flex-column gap-2 mt-2">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input category-filter" id="all-categories" value=""
                                    checked>
                    ...
                    <div class="mt-4">
                        <a href="#"
                            class="btn-link d-flex align-items-center text-dark bg-light p-2 rounded fw-medium fs-16 mb-0"
                            data-bs-toggle="collapse" data-bs-target="#stock" aria-expanded="false"
                            aria-controls="stock">المخزون
                            <i class='bx bx-chevron-down ms-auto fs-20'></i>
                        </a>
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-6">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item fw-medium"><a href="{{ route('inventory.products.index') }}"
                                        class="text-dark">المنتجات</a></li>
                                <li class="breadcrumb-item active">عرض الشبكة</li>
                            </ol>
                            <p class="mb-0 text-muted">عرض <span
                                    class="text-dark fw-semibold">{{ $products->total() ?? 0 }}</span> منتج</p>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card">
                            @if($product->images->isNotEmpty())
                                <img src="{{ storage_url($product->images->first()->image_path) }}" alt="{{ $product->name }}"
                                    class="img-fluid">
                            @else
