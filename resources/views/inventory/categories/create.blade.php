            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.inventory.categories.store') }}">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror"
                                       placeholder="أدخل اسم الفئة" value="{{ old('name') }}" required>
                                @error('name')
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label">نوع الفئة <span class="text-danger">*</span></label>
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="category_type" id="category_type_main" value="main" checked onchange="toggleParentSelect()">
                                    <label class="form-check-label" for="category_type_main">
                                        فئة رئيسية (قسم رئيسي)
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="category_type" id="category_type_sub" value="sub" onchange="toggleParentSelect()">
                        ...
                        <div class="col-lg-12" id="parent_category_wrapper" style="display: none;">
                            <div class="mb-3">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" rows="3"
                                          placeholder="أدخل وصف الفئة">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (oldParentId) {
        document.getElementById('category_type_sub').checked = true;
        toggleParentSelect();
    }
});
</script>
