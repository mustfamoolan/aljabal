@extends('layouts.vertical', ['title' => 'Create Supplier'])
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror"
                                       placeholder="أدخل اسم المورد" value="{{ old('name') }}" required>
                                @error('name')
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="contact_person" name="contact_person" class="form-control @error('contact_person') is-invalid @enderror"
                                       placeholder="أدخل اسم الشخص المسؤول" value="{{ old('contact_person') }}">
