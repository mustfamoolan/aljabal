            ...
            <div class="d-flex align-items-center gap-1">
                ...
                <div class="dropdown topbar-item">
                              ...
                              <span class="d-flex align-items-center">
                                  ...
                                  @else
                                      <div class="avatar-sm rounded-circle bg-primary bg-opacity-10 d-flex align-items-center justify-content-center">
                                          <span class="text-primary fw-semibold">{{ substr($representative->name, 0, 1) }}</span>
                                      </div>
                                  @endif
                              </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">مرحباً، {{ $representative->name }}!</h6>
                        <a class="dropdown-item" href="{{ route('representative.profile') }}">
