<div class="main-nav">
    ...
    <div class="scrollbar" data-simplebar>
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('representative.dashboard') }}">
                         <span class="nav-icon">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarOrders">
                    <ul class="nav sub-navbar-nav">
                         ...
                         <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('third', ['general', 'orders', 'list'])}}">القائمة</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('third', ['general', 'orders', 'details'])}}">التفاصيل</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('third', ['general', 'orders', 'cart'])}}">السلة</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('third', ['general', 'orders', 'checkout'])}}">الدفع</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('representative.profile') }}">
                         <span class="nav-icon">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarAuthentication">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('representative.login') }}">تسجيل الدخول</a>
                        </li>
                        <li class="sub-nav-item">
