        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.reports.index') }}">
                    ...
                    <span class="nav-text"> التقارير التفصيلية </span>
                </a>
            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarOrders">
                        <ul class="nav sub-navbar-nav">
                            ...
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="{{ route('admin.settings.order-commission.index') }}">إعدادات
                                    عمولة التجهيز</a>
                            </li>
                        </ul>
                    </div>
            ...
            @if(auth()->user()->isAdmin() || auth()->user()->can('inventory.products.view') || auth()->user()->can('inventory.categories.view') || auth()->user()->can('inventory.suppliers.view'))
                ...
                @if(auth()->user()->isAdmin() || auth()->user()->can('inventory.categories.view'))
                    <li class="nav-item">
                        <a class="nav-link menu-arrow" href="#sidebarInventoryCategories" data-bs-toggle="collapse"
                            role="button" aria-expanded="false" aria-controls="sidebarInventoryCategories">
                            <span class="nav-icon">
